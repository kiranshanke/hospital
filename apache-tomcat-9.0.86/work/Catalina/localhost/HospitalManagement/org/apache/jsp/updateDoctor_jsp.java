 ...
 * Generated at: 2025-04-11 04:05:50 UTC
...
public final class updateDoctor_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <title>Update Doctor Details</title>\n");
      out.write("    <style>\n");
      out.write("        body {\n");
      ...
      out.write("        ");
            ...
            String firstName = "", lastName = "", email = "", contactNumber = "", specialty = "";

            if (doctorId == null || doctorId.isEmpty()) {
                message = "Doctor ID is missing from the URL.";
            } else {
                try {
                    Class.forName("com.mysql.cj.jdbc.Driver");
                    try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/hospital_db", "root", "root")) {
                        ...
                        if ("POST".equalsIgnoreCase(request.getMethod())) {
                            ...
                            if (firstName.isEmpty() || lastName.isEmpty() || email.isEmpty() || contactNumber.isEmpty() || specialty.isEmpty()) {
                                ...
                                String updateSQL = "UPDATE doctor SET first_name=?, last_name=?, email=?, contact_number=?, specialty=?/* availability=?*/ WHERE id=?";
                        ...
                        // Always fetch the latest data for display
                        String fetchSQL = "SELECT * FROM doctor WHERE id=?";
      ...
      out.write("\n");
      out.write("        ");
 if (doctorId != null && !doctorId.isEmpty() && (message == null || messageClass.equals("success"))) { 
      out.write("\n");
      out.write("        <form method=\"post\" action=\"updateDoctor.jsp?doctorId=");
      out.print( doctorId );
      out.write("\">\n");
      ...
      out.write("                <input type=\"text\" id=\"contactNumber\" name=\"contactNumber\" value=\"");
      out.print( contactNumber );
      out.write("\" required>\n");
      out.write("            </div>\n");
      out.write("            <div class=\"form-group\">\n");
      out.write("                <label for=\"specialty\">Specialty</label>\n");
      out.write("                <input type=\"text\" id=\"specialty\" name=\"specialty\" value=\"");
      out.print( specialty );
      out.write("\" required>\n");
      out.write("            </div>\n");
      out.write("<!--            <div class=\"form-group\">\n");
      ...
      out.write("               \n");
      out.write("            </div>-->\n");
      out.write("            <button type=\"submit\">Update Doctor</button>\n");
      out.write("        </form>\n");
      out.write("        ");
 } 
      out.write("\n");
